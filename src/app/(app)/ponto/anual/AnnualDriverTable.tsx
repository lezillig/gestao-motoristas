...
// ou "José" — mesma normalizacao ja usada em MonthlyDriverTable.tsx.
...
export default function AnnualDriverTable({
  rows,
  gridTemplateColumns,
}: {
  rows: AnnualDriverRow[];
    ...
    <div>
      ...
      {filtered.length === 0 && (
        <p className="px-4 py-8 text-center text-sm text-slate-500">
          {trimmed ? "Nenhum motorista encontrado com esse nome." : "Nenhum motorista com hora extra neste ano."}
        </p>
      )}
      {filtered.map((r) => {
